...
exports.run = async (client, message, args) => {
  ...
  const embed = new Discord.MessageEmbed().setTimestamp().setColor("#63a4fb")
    .setAuthor(`
Sayaç başarıyla ayarlandı: ${args[0]}
Sayaç kapatmak isterseniz ${prefix}sayaç-ayarla kapat yazmanız yeterlidir.
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ["sayacayarla", "sayaçayarla"],
  permLevel: 0
};
